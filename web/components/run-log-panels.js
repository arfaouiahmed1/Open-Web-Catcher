      ...
      <CardHeader className="space-y-3 border-b px-4 py-4">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <CardDescription>
              Runtime intent, handoffs, continuation events, and routing decisions from the live trace.
            </CardDescription>
          </div>
          <Badge tone={filteredEvents.length ? "signal" : "default"}>{filteredEvents.length} observed</Badge>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Input
            ...
            placeholder="Search traces, actors, tools, routes, or continuation capsules"
          ...
          <Select
            ...
            options={[
              { value: "", label: "All trace sources" },
              { value: "agent_auto", label: "Agent auto" },
