...
const TOOL_SPECS = {
  ...
  inspect: spec(
    "Broad Puppeteer page read for the current page state. Returns high-ceiling contentLinks, navLinks, buttons, elements, iframes, frame_tree, hosting_signals, lazy_load_warmup, and a screenshot after scrolling to warm lazy content and resetting to the top.",
    {
      url: "https://example.com/watch",
      scroll: true,
      scroll_steps: 12,
    },
    {
      url: "https://example.com/watch",
      title: "Watch",
      contentLinks: [{ href: "https://example.com/watch/server-1", selector: "a" }],
      buttons: [{ text: "Server 1", selector: ".server-btn" }],
      frame_tree: [{ frame_path: "root.0", purpose_hint: "player", video_count: 1 }],
      lazy_load_warmup: { scroll_steps: 12, reset_to_top: true },
      screenshot_url: "https://res.cloudinary.com/...",
      stats: { content_links: 120, buttons: 5, lazy_load_reset_to_top: true },
    },
    {
  ...
  inspect_landing: spec(
    "Landing-page inspect optimized for routing. Returns match_candidates, navigation_links, action_targets, iframe_overview, pagination, hosting_signals, and lazy-load warmup details after top-reset scrolling.",
    { scroll: true, scroll_steps: 14 },
    {
      context_type: "landing",
      match_candidates: [{ url: "https://example.com/match/123", selector: ".match-card a", x: 640, y: 360 }],
      navigation_links: [{ url: "https://example.com/live", text: "Live" }],
      iframe_overview: { total_frames: 2, frames_with_video: 1, frames: [] },
  ...
  inspect_hosting: spec(
    "Hosting-page inspect optimized for activation and server switching. Returns server_controls, playback_targets, iframe_context, videos, popups, hosting_signals, and lazy-load warmup details after top-reset scrolling.",
    { scroll: true, scroll_steps: 12 },
    {
      context_type: "hosting",
      server_controls: [{ text: "Server 1", selector: ".server-btn", x: 580, y: 710 }],
      playback_targets: [{ kind: "video", selector: "video", x: 960, y: 540 }],
      iframe_context: { total_frames: 3, frames_with_video: 1, frames: [] },
      lazy_load_warmup: { scroll_steps: 12, reset_to_top: true },
      screenshot_url: "https://res.cloudinary.com/...",
    },
    {
  ...
  inspect_embedded: spec(
    "Embedded-page inspect optimized for nested player routing. Returns source_controls, player_targets, frame_focus_order, iframe_context, videos, popups, and lazy-load warmup details after top-reset scrolling.",
    { scroll: true, scroll_steps: 12 },
    {
      context_type: "embedded",
      source_controls: [{ text: "Source 1", selector: ".source-btn", frame_path: "root.0" }],
      player_targets: [{ kind: "video", selector: "video", frame_path: "root.0" }],
      frame_focus_order: [{ frame_path: "root.0", score: 21, video_count: 1 }],
      lazy_load_warmup: { scroll_steps: 12, reset_to_top: true },
      screenshot_url: "https://res.cloudinary.com/...",
    },
    {
