...
const TOOL_SPECS = {
  ...
  inspect: spec(
    ...
    },
    {
      ...
      wait_ms: z.number().optional().default(1500),
      max_depth: z.number().optional().default(5),
      max_children_per_node: z.number().optional().default(20),
      text_limit_per_node: z.number().optional().default(120),
      include_network: z.boolean().optional().default(true),
      include_response_bodies: z.boolean().optional().default(false),
      include_frames: z.boolean().optional().default(true),
      include_shadow_dom: z.boolean().optional().default(true),
      scroll: z.boolean().optional().default(true),
      scroll_steps: z.number().optional().default(4),
      allow_safe_interactions: z.boolean().optional().default(false),
      safe_interaction_limit: z.number().optional().default(2),
    },
    (browserWsEndpoint, toolImpls) => (args) =>
