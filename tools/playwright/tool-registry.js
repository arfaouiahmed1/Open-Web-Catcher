...
const TOOL_SPECS = {
  ...
  play_media: spec(
    ...
    { ok: true, screenshot_url: 'https://res.cloudinary.com/...', playback_started: true, needs_agent_choice: false },
    {
      frame_path: framePathSchema,
      element_ref: elementRefSchema,
      selector: selectorSchema,
  ...
  inspect_hosting: spec(
    'Hosting-page context optimized for stream extraction and LLM-chosen activation. Includes deep iframe context with iframe-local sample_buttons/sample_links/sample_videos, server controls, activation_candidates, blocker_candidates, playback targets, and popup evidence with locators and coordinates.',
    {},
    {
      context_type: 'hosting',
      server_controls: [{ text: 'Server 1', selector: '.server-btn', xpath: '//button[1]', x: 580, y: 710 }],
  ...
  inspect_embedded: spec(
    'Embedded-page context optimized for nested iframe players and LLM-chosen activation. Returns frame focus order, source controls, activation_candidates, blocker_candidates, and player targets with minimal payload bloat.',
    {},
    {
